...
experimentCase=1;       %  experimentCase=1  - Sparse projections: 22 radial lines
%                       %  experimentCase=2  - Sparse projections: 11 radial lines
%                       %  experimentCase=3  - Limited-angle (90 degrees aperture, 61 radial lines)
...
maxPSNR=130;    % maximum value of PSNR that can be achieved with the current numerical precision (double) (default: maxPSNR=255)
...
while k<k_final,
    ...
    filtered_invT_y_hat_k=function_BM3D_HT_single(theta_hat_k,std_filt);
